...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col lg:flex-row">
      ...
      {/* Sidebar */}
      <aside className={`fixed lg:sticky inset-y-0 left-0 w-[260px] bg-slate-900/95 backdrop-blur-lg border-r border-white/10 p-4 flex flex-col z-50 transform transition-transform lg:transform-none ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
      ...
      {/* Main Content */}
      <main className="flex-1 p-3 sm:p-4 lg:p-5 overflow-auto">
        {activeTab === 'calendar' && (
